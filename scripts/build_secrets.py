...
them as -D build flags. Values are only applied when the environment variable
is set, so the defaults in src/config.h are used otherwise. The secret values
